(function() {
  ...
  RegisterCtrl.$inject = ['$scope', '$ionicPopup', '$state'];

  function RegisterCtrl($scope, $ionicPopup, $state) {
    $scope.data = {};

    $scope.register = function() {
      RegisterService.RegisterUser($scope.data.username, $scope.data.password)
